...
void MainGame::init() {
    ...
    m_spriteFont = std::make_unique<PuffEngine::SpriteFont>("Fonts/chintzy.ttf", 40);
...
void MainGame::initRenderers() {
	...
	m_ballRenderers.push_back(std::make_unique<FabionacciRenderer>(m_screenWidth, m_screenHeight));
}

struct BallSpawn {
    BallSpawn(const PuffEngine::ColorRGBA8& colr,
...
#define ADD_BALL(p, ...) \
    ...
    ADD_BALL(1.0f, PuffEngine::ColorRGBA8(255, 255, 255, 255),
             2.0f, 1.0f, 0.1f, 7.0f, totalProbability);
    ADD_BALL(1.0f, PuffEngine::ColorRGBA8(1, 254, 145, 255),
             2.0f, 2.0f, 0.1f, 3.0f, totalProbability);
    ADD_BALL(1.0f, PuffEngine::ColorRGBA8(177, 0, 254, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability)
    ADD_BALL(1.0f, PuffEngine::ColorRGBA8(254, 0, 0, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
    ADD_BALL(1.0f, PuffEngine::ColorRGBA8(0, 255, 255, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
    ADD_BALL(1.0f, PuffEngine::ColorRGBA8(255, 255, 0, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
    // Make a bunch of random ball types
    for (int i = 0; i < 10000; i++) {
        ADD_BALL(1.0f, PuffEngine::ColorRGBA8(r2(randomEngine), r2(randomEngine), r2(randomEngine), 255),
...
void MainGame::drawHud() {
    const PuffEngine::ColorRGBA8 fontColor(255, 0, 0, 255);
